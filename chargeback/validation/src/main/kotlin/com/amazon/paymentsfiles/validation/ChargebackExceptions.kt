 ...
 */
class ChargebackHeaderException(cause: Throwable? = null) : IllegalArgumentException(
    "the specified header is incorrect--proper header names are " +
        enumValues<ChargebackField>().joinToString { it.fieldName },
    cause
)
