 ...
 */
class RecordAmountSumException(cause: Throwable? = null) : PayProGenerationException(
    "The deposit amount specified in the header does not match the subsequent records' amounts", cause
)
